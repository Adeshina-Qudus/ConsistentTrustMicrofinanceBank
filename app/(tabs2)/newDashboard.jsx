        ...
        <SafeAreaView>
            <View style={Styles.mainContainer}>
                ...
                <View style={Styles.avaliableService}>
                    ...
                    <View style={Styles.Services}>
                        <View style={Styles.service}>
                            <Text style={Styles.recentTrans}>Things to do </Text>
                        </View>
                           <Text style={Styles.viewAllText}>Done 1 of 3</Text>
                    </View>
                    <View style={Styles.details}>
                        <View style={Styles.kyc}>
                            <Image source={image.KYC} style={Styles.logo} />
                            <Text style={Styles.name}>Upgrade KYC Level</Text>
                            <Text style={Styles.date}>PM </Text>
                        </View>
...
const Styles = StyleSheet.create({
    ...
    limit : {
        ...
        alignItems : "center",
        borderRadius : 5,
        borderColor :  'rgba(214, 233, 241, 1)',
        borderWidth : 1,
        width : 330,
        marginTop : 15,
        height : 50
